...
import static org.firstinspires.ftc.teamcode.autonomous.RedFarRealPaths.PathState.DONE;
import static org.firstinspires.ftc.teamcode.autonomous.RedFarRealPaths.PathState.FIFTH_PATH;
import static org.firstinspires.ftc.teamcode.autonomous.RedFarRealPaths.PathState.FIRST_PATH;
import static org.firstinspires.ftc.teamcode.autonomous.RedFarRealPaths.PathState.FOURTH_PATH;
import static org.firstinspires.ftc.teamcode.autonomous.RedFarRealPaths.PathState.SECOND_PATH;
import static org.firstinspires.ftc.teamcode.autonomous.RedFarRealPaths.PathState.THIRD_PATH;
...
@Autonomous(name = "REAL Red Far")
public class RedFarReal extends BaseRobot {
    RedFarRealPaths.PathState state;
    ...
    public void nextState() {
        switch (state) {
            case FIRST_PATH:
                ...
                pathFollower = RedFarRealPaths.getPathFollower(state, 0.4);
                break;
            case SECOND_PATH:
    ...
    public void runOpMode() {
        ...
        state = FIRST_PATH;
        pathFollower = RedFarRealPaths.getPathFollower(state);
