...
public class Constants {
    ...
    public static Follower createFollower(HardwareMap hardwareMap) {
        followerConstants = new FollowerConstants()
                ...
                .headingPIDFCoefficients(new PIDFCoefficients(1.6, 0, 0, 0))
                .secondaryHeadingPIDFCoefficients(new PIDFCoefficients(0.8, 0, 0, 0))

                .drivePIDFSwitch(2)
                .drivePIDFCoefficients(new FilteredPIDFCoefficients(0.1, 0, 0.01, 0.6, 0.0))
                .secondaryDrivePIDFCoefficients(new FilteredPIDFCoefficients(0.0, 0, 0.01, 0.6, 0.0))
