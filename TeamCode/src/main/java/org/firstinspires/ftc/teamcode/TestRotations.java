...
@Autonomous
public class TestRotations extends LinearOpMode{
    DcMotor fL;
    DcMotor fR;
    DcMotor bL;
    DcMotor bR;
    ...
    DcMotor Boost;
        ...
        public void set_outake(double left_trigger, double left_bumper, int time) {
            Out.setPower(0.75*left_trigger);
...
//                double right_stick_x = 0;
                ...
                //TEST ROTATIONS
                List<Integer> rotation_times = Arrays.asList(1000, 1500, 2000, 2500, 3000);

                for (int r : rotation_times) {
                    move_bot(0, 0, 0.5, r);
                    bot_stop(5000);
                }
