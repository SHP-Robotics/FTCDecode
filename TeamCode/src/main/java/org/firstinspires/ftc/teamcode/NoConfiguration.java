...
public class NoConfiguration extends LinearOpMode {
    ...
    public void mainScreen() {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            if (gamepad.isKeyDown(GamepadKey.DPAD_DOWN) || gamepad.isKeyDown(GamepadKey.DPAD_UP)) {
                mainScreen += 1;
                mainScreen %= 2;
            }
    ...
    public void controlHub() {
        ...
        while (opModeIsActive() && !isStopRequested() && !gamepad.isKeyUp(GamepadKey.B)) {
            ...
            if (gamepad.isKeyDown(GamepadKey.DPAD_DOWN)) {
                controlHub += 1;
                controlHub %= 10;
            }

            if (gamepad.isKeyDown(GamepadKey.DPAD_UP)) {
                controlHub += 9;
                controlHub %= 10;
            }
